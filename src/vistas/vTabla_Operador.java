...
import static vistas.tablaPedidos.factory;
/**
 *
 * @author BeltariT
 */
...
//        SessionFactory factory = manager.getSessionFactory();
    ...
    private void tableOperadoresMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableOperadoresMouseClicked
       if (evt.getClickCount() == 1) {
            ...
            if(ventana.equals("pedido")){
            
                tablaPedidos.txtId.setText(cod);
                tablaPedidos.txtRazon.setText(nombre);
                tablaPedidos.txtCiudad.setText(dts.getLocalidad());
                tablaPedidos.txtProvincia.setText(dts.getProvincia());
